...
These are already solved for, but are too big to be uploaded to GitHub. The DNS dataset can be found at  https://turbulence.pha.jhu.edu/Transition_bl.aspx from the JHTDB
